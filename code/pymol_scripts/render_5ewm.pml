# PyMOL script: 5EWM (EVT-101) redocking pose overlay.
#
...
#
# Run with: pymol -cq render_5ewm.pml
python
import os
...
POSE_DIR = os.path.join(SYS_DIR, "Goldscore", "goldscore(N1000)")
cmd.load(os.path.join(POSE_DIR, "gold_protein.mol2"), "prot")
cmd.load(os.path.join(SYS_DIR, "EVT101_5ewm_exp.mol2"), "crystal")
cmd.load(os.path.join(POSE_DIR, "gold_soln_EVT101_exp_m1_166.mol2"), "pose_a")
cmd.load(os.path.join(POSE_DIR, "gold_soln_EVT101_exp_m1_349.mol2"), "pose_b")
cmd.load(os.path.join(POSE_DIR, "gold_soln_EVT101_exp_m1_259.mol2"), "pose_c")
cmd.load(os.path.join(POSE_DIR, "gold_soln_EVT101_exp_m1_976.mol2"), "pose_d")
python end
...
ray 1600, 1500
python
cmd.png(os.path.join(OUT_DIR, "5ewm_pymol.png"), dpi=300)
python end
