# PyMOL script: 3QEL (ifenprodil) redocking pose overlay.
#
...
#
# Run with: pymol -cq render_3qel.pml
python
import os
...
SYS_DIR = os.path.join(GOLD_RAW_DIR, "3qel", "redocagem")
POSE_DIR = os.path.join(SYS_DIR, "goldscore", "gold_(N1000)")
cmd.load(os.path.join(POSE_DIR, "gold_protein.mol2"), "prot")
cmd.load(os.path.join(SYS_DIR, "ifenprodil_3qel_exp.mol2"), "crystal")
cmd.load(os.path.join(POSE_DIR, "gold_soln_ifenprodil_protonado_exp_m1_675.mol2"), "pose_a")
cmd.load(os.path.join(POSE_DIR, "gold_soln_ifenprodil_protonado_exp_m1_223.mol2"), "pose_b")
cmd.load(os.path.join(POSE_DIR, "gold_soln_ifenprodil_protonado_exp_m1_625.mol2"), "pose_c")
cmd.load(os.path.join(POSE_DIR, "gold_soln_ifenprodil_protonado_exp_m1_240.mol2"), "pose_d")
python end
...
ray 1600, 1500
python
cmd.png(os.path.join(OUT_DIR, "3qel_pymol.png"), dpi=300)
python end
