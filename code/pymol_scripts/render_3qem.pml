# PyMOL script: 3QEM (Ro25-6981) redocking pose overlay.
#
...
#
# Run with: pymol -cq render_3qem.pml
python
import os
...
SYS_DIR = os.path.join(GOLD_RAW_DIR, "3qem", "redocagem")
POSE_DIR = os.path.join(SYS_DIR, "Goldscore", "gold_(N1000)")
cmd.load(os.path.join(POSE_DIR, "gold_protein.mol2"), "prot")
cmd.load(os.path.join(SYS_DIR, "ro25_3qem_exp.mol2"), "crystal")
cmd.load(os.path.join(POSE_DIR, "gold_soln_Ro25_prot_exp_m1_634.mol2"), "pose_a")
cmd.load(os.path.join(POSE_DIR, "gold_soln_Ro25_prot_exp_m1_966.mol2"), "pose_b")
cmd.load(os.path.join(POSE_DIR, "gold_soln_Ro25_prot_exp_m1_951.mol2"), "pose_c")
cmd.load(os.path.join(POSE_DIR, "gold_soln_Ro25_prot_exp_m1_774.mol2"), "pose_d")
python end
...
ray 1600, 1500
python
cmd.png(os.path.join(OUT_DIR, "3qem_pymol.png"), dpi=300)
python end
